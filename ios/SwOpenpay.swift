...
class SwOpenpay: NSObject {
  ...
  @objc
  func createCreditcard(_ name:String, resolve: @escaping RCTPromiseResolveBlock,  rejecter reject: @escaping RCTPromiseRejectBlock) -> Void {
      ...
      let card = TokenizeCardRequest(cardNumber: "4111111111111111", holderName: name as String, expirationYear: "22", expirationMonth: "10", cvv2: "111")
